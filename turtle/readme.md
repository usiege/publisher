...
- [各怀旧服整理说明](./notes/wow.md)


## 插件介绍

- [露娜整合包拆解](./notes/luna.md)
...
|TankBuddyEnh|[职业]战士 RMT助手|战士必备插件，当战士的嘲讽、惩戒痛击被抵抗向队伍/团队发送消息。|N破斧、盾墙、生命宝石、群嘲开启后向队伍/团队发送消息|`/tb`|
...
|XLoot|[辅助]拾取增强|拾取物品时拾取窗口自动跟随鼠标的位置，也可以通过链接发送物品的名称到相应的频道|-|
